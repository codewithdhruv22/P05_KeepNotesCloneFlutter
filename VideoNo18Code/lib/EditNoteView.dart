        ...
        backgroundColor: bgColor,
         ...
         actions: [
           IconButton(
             splashRadius: 17,
             onPressed: () async{
               Note newNote = Note(content: NewNoteDet , title: NewTitle , createdTime:  widget.note!.createdTime,isArchieve: widget.note!.isArchieve, pin: widget.note!.pin , id: widget.note!.id);
